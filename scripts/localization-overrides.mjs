...
const mcpConnectionKeys = [
  ...
  'Copy configuration',
  'Set KALI_USER_TOKEN in your environment. After saving, restart Codex and use /mcp to verify the connection.',
