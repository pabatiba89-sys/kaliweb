...
const localeOverrides = {
  ...
  'zh-CN': {
    ...
    'Opens your email app with the order details filled in.': '将打开邮箱，并自动填入订单信息。',
    'Request refund': '申请退款',
  ...
  'zh-TW': {
    ...
    'Opens your email app with the order details filled in.': '將開啟郵件程式，並自動填入訂單資訊。',
    'Request refund': '申請退款',
...
const translationScopes = {
  credits: new Set([
    ...
    'Voice training',
    'You save',
    'Opens your email app with the order details filled in.',
  ]),
};
