...
- 2026-07-13：数字人口播和混剪创作页的“从素材库选择”弹窗必须独立维护素材 `page + cursor + hasMore`；列表使用 `/api/material/list` 和 `MATERIAL_PAGE_SIZE`，传递 `page/page_size/pageSize/limit/start_cursor`，不足一屏时自动续载，距底部 80px 时追加，并保留显式“加载更多”与失败重试入口。
