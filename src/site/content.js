...
export const basePages = [
    ...
    },
    {
      ...
      sections: [
        ['Service provider and address', `${LEGAL_COMPANY_NAME}, Hong Kong company number ${LEGAL_COMPANY_NUMBER}, provides Kali. Company address: ${LEGAL_COMPANY_ADDRESS}. Send general enquiries and legal notices to pabatiba89@gmail.com.`],
        ...
        ['Contact and changes', 'We may update these Terms when the service or legal requirements change. Material changes will be communicated through the service or another reasonable channel. Questions and legal notices may be sent to pabatiba89@gmail.com.'],
      ],
    ...
    },
    {
      ...
      sections: [
        ['Company and privacy contact', `${LEGAL_COMPANY_NAME}, Hong Kong company number ${LEGAL_COMPANY_NUMBER}, is the service provider and data controller. Company address: ${LEGAL_COMPANY_ADDRESS}. Send privacy requests to pabatiba89@gmail.com.`],
        ...
        ['Law enforcement and government requests', 'We assess government and law-enforcement requests case by case. We disclose user data only where we determine that a request is supported by valid legal process, is sufficiently specific, and is necessary and proportionate. Our Law Enforcement Guidelines explain the information and process required for these requests.'],
      ...
      faq: [['How do I make a privacy request?', 'Email pabatiba89@gmail.com with your account identifier and the specific right you want to exercise. Do not send a password or verification code.'], ['Does Kali sell personal data?', 'Kali does not sell personal data to unrelated third parties.'], ['Can I withdraw voice or likeness authorization?', 'Yes. Contact pabatiba89@gmail.com or use an available deletion control. Withdrawal stops future consent-based processing but does not invalidate processing completed before withdrawal.']],
    },
    {
      slug: 'law-enforcement-guidelines',
      title: 'Kali Law Enforcement Guidelines',
      description: 'Requirements for authorized law-enforcement and government authorities requesting user data from Kali.',
      eyebrow: 'LAW ENFORCEMENT',
      headline: 'A lawful and rights-respecting process for government requests',
      lead: 'These Guidelines explain how authorized law-enforcement and government authorities may request user data from Kali. We cooperate with valid legal requests while protecting privacy, freedom of expression, due process, and other applicable rights.',
      bullets: ['Every request is reviewed case by case', 'Requests must use valid legal process and be narrowly scoped', 'Invalid, informal, or overly broad requests may be rejected'],
      sections: [
        ['1. Service provider and scope', `${LEGAL_COMPANY_NAME}, Hong Kong company number ${LEGAL_COMPANY_NUMBER}, provides Kali. Company address: ${LEGAL_COMPANY_ADDRESS}. These Guidelines apply only to requests from authorized law-enforcement, courts, regulators, or government authorities seeking data associated with Kali users or services.`],
        ['2. How to submit a request', 'Send the request from an official government or law-enforcement email domain to pabatiba89@gmail.com with the subject “Law Enforcement Request”. Attach a signed and dated request on official letterhead, together with the warrant, court order, subpoena, or equivalent legal process in PDF format. Documents must be in English or accompanied by an English translation. Acknowledging receipt does not waive any objection relating to jurisdiction, legal validity, scope, service, or other rights.'],
        ['3. Information required', 'Identify the requesting authority, court where applicable, responsible officer, official contact details, badge or identification number, legal authority for the request, offence or regulatory matter under investigation, and its connection to Kali. Identify the relevant account using a specific account email, user identifier, task identifier, transaction reference, or content URL. Specify each requested data category and a relevant date range. State whether user notification is legally permitted.'],
        ['4. Legal validity, necessity, and proportionality', 'Each request must cite the legal process authorizing the request and must be necessary and proportionate to a legitimate investigation or regulatory purpose. We may seek clarification, narrow a request, object to it, or reject it if it is informal, legally insufficient, addressed to the wrong entity, technically infeasible, excessively broad, or inconsistent with applicable law and rights protections.'],
        ['5. Categories of data', 'Depending on how the service was used and our applicable retention periods, we may hold account and subscriber information, login and device security records, project or interaction records, user-submitted or generated content, support communications, and payment or transaction references. These examples do not confirm that any particular record exists or will be retained. More sensitive or content data may require a higher form of legal process.'],
        ['6. User notice', 'Where required or permitted by applicable law, we may notify a user before or after disclosing data. Notice may be delayed or withheld where legally prohibited, where it would jeopardize an investigation, or where it could create a risk of harm. The requesting authority should state the legal basis and duration of any non-disclosure requirement.'],
        ['7. Preservation requests', 'A valid formal preservation request must identify the specific account, data categories, and date range to be preserved. We may preserve available data for the period required or permitted by applicable law while the requesting authority obtains the necessary legal process. Preservation does not itself authorize disclosure, and data outside the request or no longer available under ordinary retention practices cannot be recreated.'],
        ['8. Emergency requests', 'We evaluate emergency requests individually. Where information establishes a good-faith belief that there is an emergency involving imminent harm, death, or serious physical injury, we may disclose data that is reasonably necessary to prevent that harm and permitted by law. Emergency requests must come from an authorized official using an official domain and must describe the emergency, the affected person, the data sought, and how that data may avert the harm.'],
        ['9. Cross-border requests', 'Where the requesting authority and the service provider are in different jurisdictions, a Mutual Legal Assistance Treaty process, letters rogatory, or another recognized government-to-government mechanism may be required. We may require the request to be directed through the appropriate central authority before disclosing data.'],
        ['10. Accuracy, confidentiality, and use', 'The requesting authority is responsible for ensuring that submitted information is complete and accurate and that the request is made in good faith. Any disclosed data must be protected, used only for the stated lawful purpose, and handled in accordance with applicable data-protection, confidentiality, and evidence-handling requirements.'],
        ['11. Non-law-enforcement requests and updates', 'These Guidelines do not apply to private disputes, informal requests, customer-support questions, intellectual-property reports, or ordinary privacy-rights requests. Send privacy-rights requests and other enquiries to pabatiba89@gmail.com. We may update these Guidelines to reflect legal, human-rights, operational, or product developments.'],
      ],
      faq: [
        ['Will Kali respond to informal requests for user data?', 'No. Requests must come through an official channel from an authorized authority and include the legal process and information required by these Guidelines.'],
        ['Does a preservation request disclose user data?', 'No. Preservation temporarily protects available, specifically identified data from ordinary deletion; disclosure still requires valid legal process.'],
        ['Can Kali reject a government request?', 'Yes. We may reject, challenge, or narrow requests that are invalid, informal, overly broad, disproportionate, or inconsistent with applicable law and rights protections.'],
      ],
    },
    {
      slug: 'payment-policy',
      ...
      sections: [
        ...
        ['Service provider and address', `${LEGAL_COMPANY_NAME}, Hong Kong company number ${LEGAL_COMPANY_NUMBER}, provides the service. Company address: ${LEGAL_COMPANY_ADDRESS}. Billing questions and legal notices may be sent to pabatiba89@gmail.com.`],
    ...
    },
    {
      ...
      sections: [
        ...
        ['How to request a refund', 'Email pabatiba89@gmail.com with the account email, order or payment reference, purchase date, amount, reason, and relevant evidence. Never include passwords, verification codes, or complete payment-card details.'],
        ...
        ['Service provider and address', `${LEGAL_COMPANY_NAME}, Hong Kong company number ${LEGAL_COMPANY_NUMBER}, provides the service. Company address: ${LEGAL_COMPANY_ADDRESS}. Refund requests and legal notices may be sent to pabatiba89@gmail.com.`],
    ...
    },
    {
      ...
      bullets: ['Product feedback: pabatiba89@gmail.com', 'Privacy, deletion, and consent withdrawal: pabatiba89@gmail.com', `Company address: ${LEGAL_COMPANY_ADDRESS}`],
      sections: [['Company information', `${LEGAL_COMPANY_NAME}, Hong Kong company number ${LEGAL_COMPANY_NUMBER}, provides Kali. Company address: ${LEGAL_COMPANY_ADDRESS}.`], ['Product and business', 'Send product feedback, partnership questions, legal notices, and general enquiries to pabatiba89@gmail.com.'], ['Privacy requests', 'Send access, correction, deletion, account cancellation, and consent-withdrawal requests to pabatiba89@gmail.com.'], ['What to include', 'Provide the relevant account identifier, task time, feature name, and a concise description. Never include your password or one-time verification code.']],
      faq: [['Which address handles privacy requests?', 'Use pabatiba89@gmail.com for personal-information rights, deletion, account cancellation, and withdrawal of authorization.'], ['How should I report a production problem?', 'Include the approximate time, feature, task identifier if available, and what you expected to happen.'], ['Will the team ask for my password?', 'No. Do not send passwords, verification codes, or other authentication secrets.']],
    },
  ...helpPages,
];
