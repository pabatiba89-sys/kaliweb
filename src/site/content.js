...
export const basePages = [
    ...
    },
    {
      ...
      sections: [
        ...
        ['2. How to submit a request', 'Send the request from an official government or law-enforcement email domain to feedback@xyaip.fun with the subject “Law Enforcement Request”. Attach a signed and dated request on official letterhead, together with the warrant, court order, subpoena, or equivalent legal process in PDF format. Documents must be in English or accompanied by an English translation. Acknowledging receipt does not waive any objection relating to jurisdiction, legal validity, scope, service, or other rights.'],
        ...
        ['11. Non-law-enforcement requests and updates', 'These Guidelines do not apply to private disputes, informal requests, customer-support questions, intellectual-property reports, or ordinary privacy-rights requests. Send privacy-rights requests to privacy@xyaip.fun and other enquiries to feedback@xyaip.fun. We may update these Guidelines to reflect legal, human-rights, operational, or product developments.'],
      ],
      faq: [
